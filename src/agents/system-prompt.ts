...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "",
    "### Model Isolation",
    "When `kosbling.modelIsolation.enabled: true` in openclaw.json:",
    ...
    "- `/model` command is disabled — model switching is controlled by config only",
    "- `sessions_spawn` with explicit model parameter will be rejected",
    "- Cron jobs with model override will be ignored with a warning",
    "",
    "Config example:",
    "```json",
    "{",
