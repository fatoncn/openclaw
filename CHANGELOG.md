...
- Upstream sync: merge `v2026.3.8` and remove fork-only patches now covered upstream for models provider merge/baseUrl precedence (`models-config`) and HTTP failover status classification (`failover-error`).
